    ...
    <div className="bg-[#111111] text-white min-h-screen font-sans">
      ...
      <section className="bg-white border-b border-neutral-200 overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-6 pt-32 lg:pt-36 flex flex-col lg:flex-row items-center justify-between min-h-[600px]">
          ...
          {/* IMAGE (RIGHT - STUCK TO TOP) */}
          <div className="w-full lg:w-1/2 lg:absolute lg:top-0 lg:right-0 lg:h-full flex items-start justify-end mt-8 lg:mt-0">
            <img 
              src="/hero_main_clean.png" 
              alt="Plataforma Integrada" 
              className="w-full max-w-[600px] lg:max-w-none lg:w-[110%] h-auto lg:h-[110%] object-cover object-top lg:translate-x-12"
            />
          </div>
              ...
              <div className="absolute inset-0 flex flex-col p-8">
                ...
                <div className="bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-xl flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=150&auto=format&fit=crop" className="w-10 h-10 rounded-full border border-neutral-700" alt="Creator" />
                    <div>
