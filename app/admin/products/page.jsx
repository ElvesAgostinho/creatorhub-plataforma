              ...
              <tbody className="divide-y divide-neutral-100">
                {filteredRows.map(product => (
                  <tr key={product.id} className="hover:bg-neutral-50/80 transition-colors group">
                    ...
                    <td className="px-6 py-4">
                      <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold ${product.published ? 'bg-green-100 text-green-800' : 'bg-neutral-100 text-neutral-800'}`}>
